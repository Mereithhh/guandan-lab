...
[确定性核心与 32 项一致性检查](./tests/unit/conformance.test.ts) · [公平 AI 的可见信息边界](./docs/ARCHITECTURE.md) · 119 项单元/契约测试 · [beta.5 安全审查记录](./docs/SECURITY_REVIEW_BETA5.md)
...
- 本地确定性 Agent 永远可用；配置兼容 OpenAI 的服务端接口后，可让大模型决策并在赛后复盘公开事件，返回动作仍会经过本地合法性校验。
