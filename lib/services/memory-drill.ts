...
export interface CountAttempt{id?:string;round:number;kind:CountKind;seen:number;remaining:number;answer:number;correct:boolean}
export interface GridAttempt{id?:string;round:number;score:number}
