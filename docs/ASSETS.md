...
The repository does not bundle stock photography, commercial card art or third-party character artwork.

| Asset | Provenance | License |
| --- | --- | --- |
| `public/characters.png` | Original fictional pixel-art cast created for GuanDan Lab | CC BY 4.0 |
