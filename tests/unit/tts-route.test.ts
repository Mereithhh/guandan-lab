...
function request(text:string){return new Request('https://game.example/api/tts',{method:'POST',headers:{origin:'https://game.example','content-type':'application/json',cookie:providerCookie},body:JSON.stringify({text})})}
